...
Results
-------
After the data loading and processing, the results can be created. Therefore
the injuries and fatalities, as well as the economic damage are aggregated
by the event type.
```{r}
...
health.impact <- health.impact[order(health.impact$health.damage, 
                                     decreasing=TRUE), ]
economics.impact <- economics.impact[order(economics.impact$health.damage, 
                                           decreasing=TRUE), ]
```